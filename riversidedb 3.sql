...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 19, 2024 at 06:01 PM
...
('', '', '', '', '', '', 'Thursday 19th of December 2024 05:40:58 PM'),
...
INSERT INTO `tenantaccountblocka` (`RoomNo`, `FirstName`, `LastName`, `PhoneNumber`, `Username`, `Password`, `University`, `Checkin`, `D-O-B`, `MonthBalance`, `RentStatus`, `Gender`, `FatherName`, `FatherNumber`, `Disease`, `Doctor`, `BloodGroup`, `Email`) VALUES
