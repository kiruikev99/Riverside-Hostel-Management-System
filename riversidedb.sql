...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 26, 2024 at 07:19 AM
...
('Deadline of Payment Tomorrow', 'franco', '2024-08-09');
...
('C1', 'Kevin', 'Kirui', 743928989, '_kiruikev', 'kiprono04', 'Kabianga University', '2024-09-02', '2004-01-06', '1750', 'Male', 'Robert Mutai', '0722540699', '', '', '', ''),
('C2', 'Victor', 'Kosgei', 722455892, 'victor_04', '12345678', 'Kabianga University', '2024-09-18', '2001-03-07', '2760', 'Male', 'Elijah Ochieng', '0722540699', '', '', '', 'victor@gmail.com');
...
--
-- Dumping data for table `tenanttransactions`
--

INSERT INTO `tenanttransactions` (`RoomNo`, `FirstName`, `LastName`, `NumberPaid`, `AmountPaid`, `Balance`, `Method`, `Date`) VALUES
('C1', 'Kevin', 'Kirui', '254743928989', '388', '', 'Mpesa', '2024-09-03 00:00:00'),
('C1', 'Kevin', 'Kirui', '254743928989', '1', '', 'Mpesa', '2024-09-10 00:00:00'),
('C2', 'Victor', 'Kosgei', '254743928989', '10', '', 'Mpesa', '2024-09-18 00:00:00'),
('C2', 'Victor', 'Kosgei', '254743928989', '80', '3360', 'Mpesa', '2024-09-18 00:00:00'),
('C1', 'Kevin', 'Kirui', '254743928989', '100', '1900', 'Mpesa', '2024-09-18 00:00:00'),
('C2', 'Victor', 'Kosgei', '', '200', '2860', 'Cash', '2024-09-18 00:00:00'),
('C2', 'Victor', 'Kosgei', '', '100', '2760', 'Cash', '2024-09-18 00:00:00'),
('C1', 'Kevin', 'Kirui', '', '150', '1750', 'Cash', '2024-09-18 00:00:00');
...
--
ALTER TABLE `electricdb`
  ADD CONSTRAINT `electricdb_ibfk_1` FOREIGN KEY (`RoomNo`) REFERENCES `tenantaccount` (`RoomNo`);

--
-- Constraints for table `plumbingdb`
--
ALTER TABLE `plumbingdb`
  ADD CONSTRAINT `plumbingdb_ibfk_1` FOREIGN KEY (`RoomNo`) REFERENCES `tenantaccount` (`RoomNo`);

--
-- Constraints for table `tenanttransactions`
--
ALTER TABLE `tenanttransactions`
  ADD CONSTRAINT `tenanttransactions_ibfk_1` FOREIGN KEY (`RoomNo`) REFERENCES `tenantaccount` (`RoomNo`);
...
ALTER TABLE `walldb`
  ...
  ADD CONSTRAINT `walldb_ibfk_2` FOREIGN KEY (`RoomNo`) REFERENCES `tenantaccount` (`RoomNo`);
COMMIT;
